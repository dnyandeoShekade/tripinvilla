                ...
                {loading ? (
                  ...
                  paginated.map((o, i) => (
                    <tr key={o._id || i}>
                      ...
                      <td style={{ color: '#111827', fontWeight: 500 }}><ReadMore maxWords={6}>{o.ownerName}</ReadMore></td>
                      <td style={{ color: '#9CA3AF' }}><ReadMore maxWords={6}>{o.email}</ReadMore></td>
                      <td style={{ color: '#111827', fontWeight: 500 }}>{o.contactNo}</td>
                      <td style={{ color: '#6B7280' }}><ReadMore maxWords={6}>{(o.properties && o.properties.length > 0) ? o.properties.join(', ') : 'None'}</ReadMore></td>
