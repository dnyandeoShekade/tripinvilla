import { Heart, CalendarCheck, MapPin, Star, UserCircle } from 'lucide-react';
    ...
    <div className="account-dashboard-wrapper fade-in">
      ...
      <div className="dashboard-content-box">
        ...
        <div className="dashboard-capsule-nav">
          ...
          <button className="capsule-btn" onClick={() => { if (!token) { openLoginModal(); return; } setActiveMenu('Wishlist'); }}><Heart size={18} /><span>Wishlist</span></button>
          <button className="capsule-btn active" onClick={() => { if (!token) { openLoginModal(); return; } setActiveMenu('Enquiries'); }}><CalendarCheck size={18} /><span>My Enquiries</span></button>
